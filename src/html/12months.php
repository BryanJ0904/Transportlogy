...
<html lang="en">
  ...
  <body class="">
    ...
    >
      ...
      <div class="flex justify-around items-center w-1/2">
        <div class="flex justify-around items-center text-center w-3/4 h-3/4">
          <a href="index.html" class="w-1/6"
            ><span class="navbar-item active">Home</span></a
          >
          <a href="offers.html" class="w-1/6"
            ><span class="navbar-item">Offers</span></a
          >
          <a href="html.html" class="w-1/6"
            ><span class="navbar-item">About Us</span></a
          >
        </div>
      </div>
      <div class="flex justify-center items-center w-1/6 h-3/4 p-3">
        <button class="bg-gray-500 w-3/4 h-full rounded-lg text-white">
          Login
        </button>
      </div>
    </div>
    ...
    <div class="w-3/4 mx-auto h-fit z-10">
      ...
      <div class="flex justify-between min-h-96 border-2">
        ...
        <div class="flex flex-col w-1/2 text-end border-2">
          ...
          <div class="flex justify-end my-4">
            <button
              class="w-1/3 p-3 text-3xl text-white font-bold bg-purple-950 rounded-xl"
            >
              Buy Now
            </button>
          </div>
      ...
      >
        ...
        >
          ...
          <div class="flex flex-col justify-between items-center h-1/4">
            <h2 class="text-sm text-gray-400 line-through">Rp. 2.399.000,-</h2>
            <h1 class="text-xl xl:text-3xl font-bold">Rp. 2.299.000,-</h1>
          </div>
        </div>
        <div
          class="flex flex-col justify-between items-center w-1/2 lg:w-[30%] h-72 lg:h-64 rounded-xl px-8 py-5 mb-8 lg:mb-0 border-2"
